...
class FullscreenImagePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(backgroundColor: Colors.black, appBar: AppBar(backgroundColor: Colors.black, foregroundColor: Colors.white, title: const Text('Изображение')), body: Center(child: InteractiveViewer(minScale: 0.5, maxScale: 4, child: _image(item.imageUrl, MediaQuery.sizeOf(context).height, fit: BoxFit.contain))));
}
